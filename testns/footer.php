                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                ...
                                <!-- Copyright Right -->
                                <!-- <div class="copyright-right">Made with <i class="fas fa-heart"></i> By <a href="https://facebook.com/hillsoftsnetwork">Name</a></div>
                            </div> -->
                            <div class="copyright-right">Designed By Nighstone Studios</a></div>
                            </div>
                        </div>
                    </div>
                </div>
